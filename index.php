...
<head>
    ...
    <link rel="stylesheet" href="css/OwlCarousel2-2.3.4/owl.carousel.min.css">
</head>

<body>
    <!-- Header -->
    <?php
    // llamamos Header GOV.CO (subheader)
    require_once("common/subheader.php");
    // llamamos Header + navbar (header)
    require_once("common/header.php");
    ?>
    <!-- Page Content -->
    <?php
    // llamamos Banner Imagenes (banner)
    require_once("common/banner.php");
    // llamamos Booking - KUI (booking)
    require_once("common/booking-principal.php");
    ?>
