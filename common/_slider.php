...
<div class="main-banner header-text" id="top">
    <div class="Modern-Slider">
        ...
        <div class="item item-1">
            <div class="img-fill">
                <picture>
                    <img src="resources/img/slider/Banner-05052023152510.jpg" alt="" >
                </picture>
                <div class="text-content">
                    ...
                    <a href="contact.html" class="filled-button">Más Información</a>
                </div>
            </div>
        </div>
        <!-- // Item -->
        ...
        <div class="item item-2">
            <div class="img-fill">
                <picture>
                    <img src="resources/img/slider/Banner-05052023152817.jpg" alt="">
                </picture>
                <div class="text-content">
